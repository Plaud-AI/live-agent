export default {
  ...
  'auth.displayName': '昵称',
  'auth.displayNamePlaceholder': '请输入您的昵称（可选）',
  'auth.forgotPassword': '忘记密码？',
  'auth.orContinueWith': '或使用以下方式继续',
  'auth.createAccount': '创建账号',
  'auth.passwordHint': '密码至少8个字符',
  'auth.agreeToTerms': '继续即表示您同意我们的',
  ...
  'auth.googleNotLoaded': 'Google登录服务未加载',
  'auth.googleLoginFailed': 'Google登录失败',
  'auth.appleNotLoaded': 'Apple登录服务未加载',
  'auth.appleLoginFailed': 'Apple登录失败',
  'auth.verifyEmail': '验证邮箱',
  'auth.verifyEmailSuccess': '邮箱验证成功！',
  'auth.verifyEmailFailed': '邮箱验证失败',
  'auth.resendVerification': '重新发送验证邮件',
  'auth.resendVerificationSuccess': '验证邮件已发送',
  'auth.resetPassword': '重置密码',
  'auth.resetPasswordSuccess': '密码重置成功',
  'auth.resetPasswordFailed': '密码重置失败',
