export default {
  ...
  'auth.displayNamePlaceholder': 'Enter your display name (optional)',
  ...
  'auth.registrationSuccess': 'Registration successful! Please check your email for verification',
  'auth.registrationFailed': 'Registration failed',
  'auth.googleNotLoaded': 'Google Sign-In service not loaded',
  'auth.googleLoginFailed': 'Google login failed',
  'auth.appleNotLoaded': 'Apple Sign-In service not loaded',
  'auth.appleLoginFailed': 'Apple login failed',
  'auth.verifyEmail': 'Verify Email',
  'auth.verifyEmailSuccess': 'Email verified successfully!',
  'auth.verifyEmailFailed': 'Email verification failed',
  'auth.resendVerification': 'Resend verification email',
  'auth.resendVerificationSuccess': 'Verification email sent',
