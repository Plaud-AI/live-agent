...
## Retrieved Context (Query-Relevant Memories)
{{relevant_memory}}
Treat retrieved memories as supplementary context relevant to the user's current query. Use them naturally if helpful, but don't force references.
