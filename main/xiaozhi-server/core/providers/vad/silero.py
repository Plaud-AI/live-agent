...
from .base import VAD, VADStream, VADEvent, VADEventType, VADCapabilities
from core.utils.exp_filter import ExpFilter
from core.utils.audio import AudioFrame, combine_audio_frames
...
class SileroVAD(VAD):
    ...
    def update_options(
        ...
        *,
        ...
        prefix_padding_duration:  Optional[float] = None,
        max_buffered_speech:  Optional[float] = None,
