    ...
    async def _run(self, output_emitter: AudioEmitter) -> None:
        ...
        async def _sentence_task(ws: aiohttp.ClientWebSocketResponse) -> None:
            ...
            try:
                ...
                logger.bind(tag=__name__).error(f"Sentence task error: {e}")
                raise
        ...
        async def _recv_task(ws: aiohttp.ClientWebSocketResponse) -> None:
            ...
            try:
                ...
                logger.bind(tag=__name__).error("Cartesia WebSocket receive timeout")
                raise
            except Exception as e:
                logger.bind(tag=__name__).error(f"Receive task error: {e}")
                raise
        ...
        try:
            ...
            logger.bind(tag=__name__).error(f"Cartesia WebSocket error: {e}")
            raise
