...
extends the OpenAI ASR class with Groq-specific configuration.
"""
...
from core.providers.asr.openai.stt import ASR as OpenAIASR
...
class ASR(OpenAIASR):
    ...
    This class extends OpenAI's ASR implementation since Groq's API
