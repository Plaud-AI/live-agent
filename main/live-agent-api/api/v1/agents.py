...
from infra import get_db, get_s3, get_openai
...
async def generate_persona(
    ...
    **Modes:**
    - `quick`: Fast non-streaming, returns JSON with instruction + greeting + closing (for initial creation)
    ...
    **Returns:**
    - quick mode: `{"code": 200, "data": {"instruction": "...", "greeting": "...", "closing": "..."}}`
    ...
    if mode == "optimize":
        ...
        try:
            ...
            # Map voice_opening/voice_closing to greeting/closing for client compatibility
            response_data = {
                "instruction": result.get("instruction", ""),
                "greeting": result.get("voice_opening", ""),
                "closing": result.get("voice_closing", "")
            }
